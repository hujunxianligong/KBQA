...
public class BytesToHexString {
    ...
    public static final String OUT_PATH = "/mnt/vol_0/wnd/usr/leagal/一行三会数据/金融法律法规/exchange/";
    /**
     * 根据文件流判断图片类型
     * @param fis
...
//                    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        bytesToHexString.exchangeWord("/mnt/vol_0/wnd/usr/leagal/一行三会数据/金融法律法规/中国证券监督管理委员会");///home/hadoop/下载/pdf-txt
